...
class Vaporeon(Pokemon):
    def __init__(self, owner):
                                # PS, ATQ, DEF, VEL
        super().__init__('agua', 464, 319, 219, 229, owner=owner)
...
class Flareon(Pokemon):
    def __init__(self, owner):
                                # PS, ATQ, DEF, VEL
        super().__init__('fuego', 334, 359, 219, 229, owner=owner)
...
class Jolteon(Pokemon):
    def __init__(self, owner):
                                     # PS, ATQ, DEF, VEL
        super().__init__('electrico', 334, 287, 219, 359, owner=owner)
...
class Eevee(Pokemon):
    def __init__(self, owner):
                                  # PS, ATQ, DEF, VEL
        super().__init__('normal', 314, 229, 218, 229, owner=owner)
